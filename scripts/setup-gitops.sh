...
PAYLOAD_PATH2="${PAYLOAD_BASE_PATH}/namespace/${NAMESPACE2}"
...
TOKEN="${PAYLOAD_TOKEN}" "${SCRIPT_DIR}/setup-payload.sh" "${NAME}" "${PAYLOAD_REPO}" "${PAYLOAD_PATH}" "${NAMESPACE}" "${CONTENT_DIR}" "${PAYLOAD_PATH2}" "${NAMESPACE2}"
